...
public void OnPluginStart()
{
	...
	g_cvRestoreHealth[SMOKER] = CreateConVar("l4d2_kill_smoker_restore_health", "8", "杀死smoker加多少血", FCVAR_NONE);
	g_cvRestoreHealth[BOOMER] = CreateConVar("l4d2_kill_boomer_restore_health", "6", "杀死boomer加多少血", FCVAR_NONE);
	g_cvRestoreHealth[HUNTER] = CreateConVar("l4d2_kill_hunter_restore_health", "10", "杀死hunter加多少血", FCVAR_NONE);
	g_cvRestoreHealth[SPITTER] = CreateConVar("l4d2_kill_spitter_restore_health", "6", "杀死spitter加多少血", FCVAR_NONE);
	g_cvRestoreHealth[JOCKEY] = CreateConVar("l4d2_kill_jockey_restore_health", "8", "杀死jockey加多少血", FCVAR_NONE);
	g_cvRestoreHealth[CHARGER] = CreateConVar("l4d2_kill_charger_restore_health", "10", "杀死charger加多少血", FCVAR_NONE);

	g_cvRestoreHealth[WITCH] = CreateConVar("l4d2_kill_witch_restore_health", "20", "杀死witch加多少血", FCVAR_NONE);
	g_cvRestoreHealth[TANK] = CreateConVar("l4d2_kill_tank_restore_health", "50", "杀死tank加多少血", FCVAR_NONE);

	g_cvMaxHealthLimit = CreateConVar("l4d2_kill_si_restore_health_Limit", "145", "达到多少血量后不再加血", FCVAR_NONE);
