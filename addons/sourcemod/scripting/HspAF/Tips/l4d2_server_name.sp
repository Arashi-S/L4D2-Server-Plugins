...
public void OnPluginStart()
{
	...
	g_hBaseModeCode = CreateConVar("sn_base_mode_code", "a", "基本模式名称代码", CVAR_FLAG, true, 0.0);
...
void setServerName()
{
	...
	char ModeName[MODE][128] = {"[普通战役]","[标准型药役]","[1VHunter]","[未指定模式]","[无限火力]","[困难无限]","[药役A]","[药役B]","[药役C]","[药役D]","[单人药役]","[HT训练]","[HT x Witch]"};
